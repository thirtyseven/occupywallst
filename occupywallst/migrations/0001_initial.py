...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('occupywallst_verbiagetranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('verbiage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['occupywallst.Verbiage'])),
        ...
        db.create_table('occupywallst_ride', (
            ...
            ('seats_used', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('info', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('forum_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['occupywallst.Article'], null=True, blank=True)),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    models = {
        ...
        'occupywallst.forumpost': {
            'Meta': {'object_name': 'ForumPost', 'db_table': "'occupywallst_article'", '_ormbases': ['occupywallst.Article'], 'proxy': 'True'}
        },
        ...
        'occupywallst.ride': {
            ...
            'forum_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['occupywallst.Article']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'seats_used': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
        ...
        'occupywallst.verbiagetranslation': {
            ...
            'language': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'rendered': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'verbiage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['occupywallst.Verbiage']"})
        }
    }

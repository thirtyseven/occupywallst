...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.is_verified'
        db.add_column('occupywallst_userinfo', 'is_verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.is_verified'
        db.delete_column('occupywallst_userinfo', 'is_verified')
